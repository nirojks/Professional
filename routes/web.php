...
use App\Http\Controllers\Admin\PaymentCardLogoController;
...
Route::get('/gmap/textsearch/{query}', function ($query) {
    $curl = curl_init();

    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://maps.googleapis.com/maps/api/place/textsearch/json?key='.env('GOOGLE_MAP_API').'&query='.$query,
...
Route::get('listing-category',[HomeController::class,'listingCategory'])->name('listing.category');
...
Route::group(['as'=> 'user.', 'prefix' => 'user'],function (){
    ...
    Route::post('flutterwave-payment',[PaymentController::class,'fluttereavePayment'])->name('flutterwave-payment');
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    Route::resource('card-icon',PaymentCardLogoController::class);
    Route::get('card-icon-status/{id}',[PaymentCardLogoController::class,'changeStatus'])->name('card-icon.status');
