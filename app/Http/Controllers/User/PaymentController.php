...
class PaymentController extends Controller
{
    ...
    public function purchase($id){
        ...
        if($package){
            if($package->package_type==0){
                ...
                return view('user.profile.payment',compact('stripe','id','websiteLang','menus','image','razorpay','paymentSetting','package','package_price','flutterwave','setting','user','paystack','instamojo','mollie','paymongo'));
            }
        }else{
            $notification=array(
    ...
    public function fluttereavePayment(Request $request){
        $flutterwave = Flutterwave::first();
        $curl = curl_init();
