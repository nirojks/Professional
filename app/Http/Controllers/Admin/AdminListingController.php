...
class AdminListingController extends Controller
{
    ...
    {
        $listings=Listing::orderBy('id','desc')->where('user_type',0)->get();
        $websiteLang=$this->websiteLang;
        return view('admin.listing.index',compact('listings','websiteLang'));
    }

    public function myListing(){
        $listings=Listing::orderBy('id','desc')->where('user_type',1)->get();
        $websiteLang=$this->websiteLang;
        return view('admin.listing.my-listing',compact('listings','websiteLang'));
    }

    public function pendingListing(){
        $listings=Listing::orderBy('id','desc')->where(['user_type'=>0,'status'=>0])->get();
        $websiteLang=$this->websiteLang;
        return view('admin.listing.pending-listing',compact('listings','websiteLang'));
    }
    ...
    public function create()
    {
        ...
        $websiteLang=$this->websiteLang;
        return view('admin.listing.create',compact('listingCategories','locations','aminities','websiteLang'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.listing.edit',compact('listingCategories','locations','aminities','listing','websiteLang','confirmNotify'));
    }
