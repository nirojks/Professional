...
class PaymentAccountController extends Controller
{
    ...
    public function update(Request $request, PaymentAccount $paymentAccount)
    {
        ...
        $customMessages = [
            ...
            'paypal_currency_code.required' => $this->errorTexts->where('id',72)->first()->custom_text,
            'paypal_country_code.required' => $this->errorTexts->where('id',113)->first()->custom_text,
        ];
    ...
    public function stripeUpdate(Request $request , $id){
       ...
       $customMessages = [
           ...
           'stripe_currency_rate.required' => $this->errorTexts->where('id',106)->first()->custom_text,
            'stripe_currency_code.required' => $this->errorTexts->where('id',72)->first()->custom_text,
            'stripe_country_code.required' => $this->errorTexts->where('id',113)->first()->custom_text,
       ];
   ...
   public function razorpayUpdate(Request $request,$id){
        ...
        $customMessages = [
            'razorpay_key.required' => $this->errorTexts->where('id',108)->first()->custom_text,
            'razorpay_secret.required' => $this->errorTexts->where('id',109)->first()->custom_text,
            ...
            'currency_rate.numeric' => $this->errorTexts->where('id',110)->first()->custom_text,
            'currency_code.required' => $this->errorTexts->where('id',72)->first()->custom_text,
            'country_code.required' => $this->errorTexts->where('id',113)->first()->custom_text,
        ];
        $this->validate($request, $rules,$customMessages);
    ...
    public function bankUpdate(Request $request,$id){
       ...
       $customMessages = [
           'bank_account.required' => $this->errorTexts->where('id',107)->first()->custom_text,
       ];
   ...
   public function flutterwaveUpdate(Request $request, $id){
        ...
        $customMessages = [
            'public_key.required' => $this->errorTexts->where('id',111)->first()->custom_text,
            'secret_key.required' => $this->errorTexts->where('id',112)->first()->custom_text,
    ...
    public function paystackUpdate(Request $request, $id){
        ...
        // project demo mode check
         ...
         $customMessages = [
             'paystack_public_key.required' => $this->errorTexts->where('id',111)->first()->custom_text,
             'paystack_secret_key.required' => $this->errorTexts->where('id',112)->first()->custom_text,
             'paystack_currency_rate.required' => $this->errorTexts->where('id',106)->first()->custom_text,
             'paystack_currency_name.required' => $this->errorTexts->where('id',72)->first()->custom_text,
             'paystack_country_name.required' => $this->errorTexts->where('id',113)->first()->custom_text,
         ];
         $this->validate($request, $rules,$customMessages);
     ...
     public function updateMollie(Request $request){
        ...
        $customMessages = [
            'mollie_key.required' => $this->errorTexts->where('id',114)->first()->custom_text,
            'mollie_currency_rate.required' => $this->errorTexts->where('id',106)->first()->custom_text,
            'mollie_currency_name.required' => $this->errorTexts->where('id',72)->first()->custom_text,
            'mollie_country_name.required' => $this->errorTexts->where('id',113)->first()->custom_text,
        ];
        $this->validate($request, $rules,$customMessages);
    ...
    public function updateInstamojo(Request $request){
        ...
        $customMessages = [
            'api_key.required' => $this->errorTexts->where('id',115)->first()->custom_text,
            'auth_token.required' => $this->errorTexts->where('id',116)->first()->custom_text,
            'currency_rate.required' => $this->errorTexts->where('id',106)->first()->custom_text,
