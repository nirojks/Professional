            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.listing-category.update',$listingCategory->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div> <p>{{ $websiteLang->where('id',366)->first()->custom_text }}:</p> </div>
                                <div class="my-2">
                                    <img src="{{ $listingCategory->icon_image ? url($listingCategory->icon_image) : '' }}" alt="old Icon image">
                                </div>
                                <div class="form-group">
                                    <label for="icon_image">{{ $websiteLang->where('id',361)->first()->custom_text }}</label>
