...
@section('title')
<title>{{ $websiteLang->where('id',157)->first()->custom_text }}</title>
@endsection
@section('admin-content')
    ...
    <div class="row">
        <div class="col-md-10">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('id',157)->first()->custom_text }}</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.settings.update',$setting->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',97)->first()->custom_text }}</label>
                            <div><input type="file" name="logo" class="form-control"></div>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',173)->first()->custom_text }}</label>
                            <br>
                            @if ($setting->favicon)
                        ...
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',172)->first()->custom_text }}</label>
                            <div><input type="file" name="favicon" class="form-control"></div>
                        </div>


                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',477)->first()->custom_text }}</label>
                            <input type="text" name="dashboard_header" class="form-control" value="{{ $setting->dashboard_header }}">
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',478)->first()->custom_text }}</label>
                            <input type="text" name="dashbaord_header_icon" class="form-control custom-icon-picker" value="{{ $setting->dashbaord_header_icon }}">
                        </div>


                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',174)->first()->custom_text }}</label>
                            <input type="email" name="email" class="form-control" value="{{ $setting->email }}">
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',175)->first()->custom_text }} </label>
                            <select name="save_contact_message" id="" class="form-control">
                                <option {{ $setting->save_contact_message==0 ? 'selected':'' }} value="0">{{ $websiteLang->where('id',124)->first()->custom_text }}</option>
                                <option {{ $setting->save_contact_message==1 ? 'selected':'' }} value="1">{{ $websiteLang->where('id',123)->first()->custom_text }}</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',177)->first()->custom_text }}</label>
                            <select name="text_direction" id="" class="form-control">
                                <option {{ $setting->text_direction=='LTR' ? 'selected':'' }} value="LTR">{{ $websiteLang->where('id',181)->first()->custom_text }}</option>
                                <option {{ $setting->text_direction=='RTL' ? 'selected':'' }} value="RTL">{{ $websiteLang->where('id',182)->first()->custom_text }}</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',178)->first()->custom_text }}</label>
                        ...
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',179)->first()->custom_text }}</label>
                            <input type="text" class="form-control" name="currency_icon" value="{{ $setting->currency_icon }}">
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',479)->first()->custom_text }} (per USD)</label>
                        ...
                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',402)->first()->custom_text }}</label>
                            <input type="number" class="form-control" name="prenotification_day" value="{{ $setting->prenotification_day }}">
                        </div>

                        <div class="form-group">
                            <label for="">{{ $websiteLang->where('id',446)->first()->custom_text }}</label>
                            <select name="allow_credit_card_section" id="allow_credit_card_section" class="form-control">
                                <option {{ $setting->allow_credit_card_section==1 ? 'selected' : 'null' }} value="1">{{ $websiteLang->where('id',123)->first()->custom_text }}</option>
                                <option {{ $setting->allow_credit_card_section==0 ? 'selected' : 'null' }} value="0">{{ $websiteLang->where('id',124)->first()->custom_text }}</option>
                            </select>
                        </div>
        ...
        <div class="form-group">
            <label for="">{{ $websiteLang->where('id',180)->first()->custom_text }}</label>
