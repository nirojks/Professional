                ...
                <form action="{{ route('admin.payment-account.update',$paymentAccount->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="account_mode" id="" class="form-control">
                            <option {{ $paymentAccount->account_mode=='live' ? 'selected':'' }} value="live">{{ $websiteLang->where('id',486)->first()->custom_text }}</option>
                            <option {{ $paymentAccount->account_mode=='sandbox' ? 'selected':'' }} value="sandbox">{{ $websiteLang->where('id',487)->first()->custom_text }}</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">{{ $websiteLang->where('id',505)->first()->custom_text }}</label>
                                <select name="paypal_country_code" id="" class="form-control select2">
                                    <option value="">{{ $websiteLang->where('id',506)->first()->custom_text }}
                                  </option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="paypal_currency_code" id="" class="form-control select2">
                                    <option value="">{{ $websiteLang->where('id',508)->first()->custom_text }}
                                  </option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">{{ $websiteLang->where('id',509)->first()->custom_text }} ({{ $websiteLang->where('id',510)->first()->custom_text }} {{ $setting->currency_name }})</label>
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('id',484)->first()->custom_text }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.razorpay-update',$razorpay->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="">{{ $websiteLang->where('id',488)->first()->custom_text }}</label>
                        <input type="text" class="form-control" name="razorpay_key" value="{{ $razorpay->razorpay_key }}">

                    </div>
                    <div class="form-group">
                        <label for="">{{ $websiteLang->where('id',489)->first()->custom_text }}</label>
                    ...
                    <div class="form-group">
                        <label for="">{{ $websiteLang->where('id',490)->first()->custom_text }}</label>
                        <br>
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('id',500)->first()->custom_text }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.flutterwave-update',$flutterwave->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="">{{ $websiteLang->where('id',501)->first()->custom_text }}</label>
                        <input type="text" class="form-control" name="public_key" value="{{ $flutterwave->public_key }}">

                    </div>
                    <div class="form-group">
                        <label for="">{{ $websiteLang->where('id',502)->first()->custom_text }}</label>
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('id',504)->first()->custom_text }}</h6>
            </div>
            <div class="card-body">
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('id',511)->first()->custom_text }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.mollie-update', $mollie->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="">{{ $websiteLang->where('id',512)->first()->custom_text }}</label>
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('id',513)->first()->custom_text }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.instamojo-update', $instamojo->id) }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="">{{ $websiteLang->where('id',514)->first()->custom_text }}</label>
                        <select name="account_mode" id="account_mode" class="form-control">
                            <option value="Sandbox">{{ $websiteLang->where('id',516)->first()->custom_text }}</option>
                            <option value="Live">{{ $websiteLang->where('id',515)->first()->custom_text }}</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="">{{ $websiteLang->where('id',517)->first()->custom_text }}</label>
                        <input type="text" name="api_key" class="form-control" value="{{ $instamojo->api_key }}">
                    </div>

                    <div class="form-group">
                        <label for="">{{ $websiteLang->where('id',518)->first()->custom_text }}</label>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('id',522)->first()->custom_text }}</h6>
                    </div>
                    <div class="card-body">
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('id',485)->first()->custom_text }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.bank-update',$paymentAccount->id) }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="bank_account">{{ $websiteLang->where('id',491)->first()->custom_text }}</label>
