...
@section('user-content')
    ...
    <div class="page-content">
        ...
        <div class="container main-categories-slider-outer">
            <div class="main-categories-slider">
                <div class="owl-carousel banner-categories owl-btn-vertical-center">
                    @foreach ($listingCategories as $category)
                        <div class="item">
                            <a href="{{ route('listings',['category_slug'=>$category->slug, 'page_type' => 'list_view']) }}" class="main-categories-box-outer site-text-primary text-center v-icon-effect">
        ...
        <div class="section-full home-overview-bg  p-t80 p-b140  map-animation-section overlay-wraper bg-cover bg-no-repeat" style="background-image:url({{ $bannerImages->where('id',13)->first()->image ? asset($bannerImages->where('id',13)->first()->image) : '' }});">
        ...
        <div class="section-full mobile-map-animation-padding p-t80 p-b80 bg-orange-light dot-left-top-img dot-right-bottom-img">
            ...
            <div class="section-content container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 m-b30">
                        <div class="featured-cat-box bg-cover bg-no-repeat v-icon-effect" style="background-image:url({{ $category->image ?  url($category->image) : '' }})">
                            <div class="featured-cat-text clearfix">
                                ...
                                <div class="featured-cat-name-outer">
                                    ...
                                    @endphp
                                    <span class="py-1 featured-cat-user color-lebel {{ $color }}">{{ $qty }} {{ $websiteLang->where('id',56)->first()->custom_text }}</span>
                                </div>
                            </div>
            ...
            <div class="text-center m-t10">
                <a href="{{ route('listing.category') }}" class="site-button-secondry site-btn-effect" data-hover="Read More">{{ $websiteLang->where('id',5)->first()->custom_text }}</a>
            </div>
        ...
        <div class="section-full home-location-bg  p-t80 p-b50 site-bg-primary dot-left-top-bg-dark bg-repeat-x bg-bottom-center">
            ...
            <div class="section-content container">
                ...
                <div class="filter-wrap p-b20 text-center">
                    <ul class="filter-navigation masonry-filter filter-gradi">
                        <li class="active"><a data-filter="*" data-hover="All" href="javascript::void">{{ $websiteLang->where('id',6)->first()->custom_text }}</a></li>
                        @foreach ($locations as $index => $location)
                        <li><a data-filter=".{{ $location->id }}" href="javascript::void">{{ $location->location }}</a></li>
                        @endforeach
                    </ul>
                </div>
                <!-- PAGINATION END -->
                ...
                <div class="masonry-wrap mfp-gallery work-grid row clearfix">
                    ...
                    <div class="masonry-item {{ $location->id }}  col-lg-4 col-md-6 col-sm-12 m-b30">
                        <div class="cities-slide-box bg-cover bg-no-repeat" style="background-image:url({{ $location->image ? asset($location->image) : '' }})">
                            @php
                            ...
                            @endphp
                            <span class="py-1 cities-slide-user color-lebel {{ $color }}">{{ $qty }} {{ $websiteLang->where('id',56)->first()->custom_text }}</span>
                            ...
                            <a href="{{ route('listings',['location_slug'=>$location->slug, 'page_type' => 'list_view']) }}" class="cities-slide-linking"></a>
                        </div>
                    </div>
                    @php
                        $colorId++;
                    ...
                    @foreach ($listings as $index => $listing)
                        ...
                        <div class="item">
                            <div class="listing-cat-box">
                                ...
                                @endphp
                                <span class="listing-category-name color-lebel {{ $color }}">{{ $listing->listingCategory->name }}</span>
                                <div class="wt-listing-view-section">
                                    <ul>
                                        @guest
                                        <li>
                                            <a href="javascript::void" class="listing-cat-preview" data-toggle="modal" data-target=".sign-in-modal">
                                        ...
                                        @endguest
                                        <li>
                                            <a href="javascript::void" class="listing-cat-preview" data-toggle="modal" data-target=".preview-place-{{ $listing->id }}">
                                                <i class="fa fa-eye "></i>
                                            </a>
                                        </li>
                                    </ul>
            ...
            <div class="container">
                ...
                <div class="section-content">
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="blog-post latest-blog-1 overlay-wraper post-overlay  large-date bg-cover bg-no-repeat bg-top-center" style="background-image:url({{ $blog->thumbnail_image ?  url($blog->thumbnail_image) : '' }})">
                                ...
                                @endphp
                                <div class="blog-category"><span class="{{ $color }}">{{ $blog->category->name }}</span></div>
                    ...
                    <div class="owl-carousel testimonial-home dark-next-prev">
                        ...
                        <div class="item">
                            <div class="testimonial-2  bg-white corner-radius">
                                <div class="testimonial-pic radius shadow"><img src="{{ asset($testimonial->image) }}" width="100" height="100" alt=""></div>
                                <div class="testimonial-content  p-a30">
                                    ...
                                    <div class="testimonial-detail clearfix">
                                        <div class="testimonial-info">
                                            ...
                                            <span class="testimonial-position site-text-secondry">{{ $testimonial->designation }}</span>
