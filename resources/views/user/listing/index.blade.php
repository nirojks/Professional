                                ...
                                <form action="{{ route('search-listing') }}" method="GET">
                                    ...
                                    <div class="form-group filter-address-inputs">
                                        <div class="form-group">
                                            ...
                                            <input id="keyword-value" type="text" class="form-control" name="longlat" placeholder="longitude,latitude" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group filter-address-inputs">
                                        <div style="position: relative;">
                                            <div class="form-group" style="margin-bottom:0;">
                                                <input id="input-keyword" type="text" name="maplocation" class="form-control" placeholder="Choose Location" />
                                            </div>
